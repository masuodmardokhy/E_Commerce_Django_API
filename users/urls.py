...
urlpatterns = [   # url for function base view
   ...
   path('user_view_set/create_user/', views.UserViewSet.as_view({'get': 'create_user'}), name='create_user'),   # create user(sign up) API
   ...
   path('user_view_set/user_sign_out/', views.UserViewSet.as_view({'get': 'user_sign_out'}),name='user_sign_out'),  # user sign out API
